...
def shortest_handle
    ...
    @journalists.each_with_index {|val, i|
        # Initialisation : shortest_word devient le premier mot de la liste --cette ligen ne sera exécuter qu'au premier tour
...
def alphabetical_order
    # On pourrais utiliser .tr afin de supprimer les caractére (@ et _) et ainsi avoir une vrai liste trier alphétiquement mais je n'arrive pas à joindre les deux tableaux
    alphabetical_list = []
    @journalists.each_with_index {|value, index|
        alphabetical_list << value.downcase
    }
...
def perform
    ...
    when 5
        ...
        gets.chomp.to_i
        puts "Non, je rigole, ce n'est pas parfait et j'ai galérer mais j'y suis arrivé !!"
        alphabetical_order
    when 6
        size_list = size_handle
